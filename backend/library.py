...
TERM_TRANSLATIONS = {
    ...
    "Healing Hands": "治疗之手",
    "Light Bearer": "光明使者",
    "Celestial Revelation": "天界启示",
    "Draconic Ancestry": "龙族血脉",
    "Breath Weapon": "吐息武器",
    "Damage Resistance": "伤害抗性",
    "Draconic Flight": "龙翼飞行",
    "Gnomish Cunning": "侏儒狡黠",
    "Gnomish Lineage": "侏儒血脉",
    "Giant Ancestry": "巨人血脉",
    "Large Form": "巨化形态",
    "Powerful Build": "强壮体格",
    "Adrenaline Rush": "肾上腺素爆发",
    "Relentless Endurance": "坚韧不屈",
    "Fiendish Legacy": "邪魔遗赠",
    "Otherworldly Presence": "异界风姿",
    # Backgrounds
    "Acolyte": "侍祭",
    "Criminal": "罪犯",
    "Entertainer": "艺人",
    ...
    "20 arrows per purchase.": "每次购买包含20支箭矢。",
    "Can double as a focus when the class rules permit.": "若职业规则允许，也可兼作法器。",
