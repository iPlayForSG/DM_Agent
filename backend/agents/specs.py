...
AGENT_SPECS = {
    ...
    AgentRole.EXPLORATION: AgentSpec(
        ...
        (
            ...
            "roll_skill_check", "roll_saving_throw", "cast_spell", "save_monster_template",
            "estimate_encounter_difficulty", "estimate_monster_cr", "start_encounter",
        ),
    ),
    AgentRole.COMBAT: AgentSpec(
        ...
        (
            ...
            "record_major_experience", "record_chapter_progress", "set_scene", "set_active_character",
            "roll_skill_check", "roll_saving_throw", "cast_spell", "save_monster_template",
            "estimate_encounter_difficulty", "estimate_monster_cr", "set_defeat_state",
