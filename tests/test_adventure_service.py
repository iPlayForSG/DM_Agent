        ...
        raw_response = """```json
{
  ...
  "tone": "街头诡秘",
  "difficulty": "中等",
  "opening_scene": "你们抵达雾港时，潮水已经漫过旧码头的第二级石阶。一个浑身湿透的书记员把蜡封残片塞进你手里，身后传来行会打手的脚步声。远处钟楼只敲了半下，雾里却有人回答。你们可以先护住书记员、追查蜡封来源，或直接面对逼近的人群。"
}
```"""
  ...
  "tone": "阴郁西幻",
  "difficulty": "中等",
  "opening_scene": "你们在边境酒馆听见商队首领压低声音求助：三名护卫昨夜被拖进旧矿坑，入口处留着地精的短矛和一枚刻着散塔林会暗记的铜扣。村镇守卫不愿下井，你们可以先盘问幸存马夫，或立刻前往矿坑入口。"
}""")
